...
labels = dataset['five_thousand_likes']

train_x, valid_x, train_y, valid_y = model_selection.train_test_split(dataset['message'], labels)
...
total_count_vect = count_vect.transform(dataset['message'])
total_tfidf_vect = tfidf_vect.transform(dataset['message'])
total_ngram = tfidf_vect_ngram.transform(dataset['message'])
total_chars = tfidf_vect_ngram_chars.transform(dataset['message'])

scores = cross_val_score(naive_bayes.MultinomialNB(), total_count_vect, labels, cv=10)
print("NB CV Count Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
scores = cross_val_score(linear_model.LogisticRegression(), total_count_vect, labels, cv=10)
print("LR CV Count Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
scores = cross_val_score(ensemble.RandomForestClassifier(), total_count_vect, labels, cv=10)
print("RF CV Count Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
scores = cross_val_score(svm.SVC(), total_count_vect, labels, cv=10)
print("SVC CV Count Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))

scores = cross_val_score(naive_bayes.MultinomialNB(), total_tfidf_vect, labels, cv=10)
print("NB tfidf Word Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
scores = cross_val_score(linear_model.LogisticRegression(), total_tfidf_vect, labels, cv=10)
print("LR tfidf Word Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
scores = cross_val_score(ensemble.RandomForestClassifier(), total_tfidf_vect, labels, cv=10)
print("RF tfidf Word Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
scores = cross_val_score(svm.SVC(), total_tfidf_vect, labels, cv=10)
print("SVC tfidf Word Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))

scores = cross_val_score(naive_bayes.MultinomialNB(), total_ngram, labels, cv=10)
print("NB Ngram Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
scores = cross_val_score(linear_model.LogisticRegression(), total_ngram, labels, cv=10)
print("LR Ngram Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
scores = cross_val_score(ensemble.RandomForestClassifier(), total_ngram, labels, cv=10)
print("RF Ngram Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
scores = cross_val_score(svm.SVC(), total_ngram, labels, cv=10)
print("SVC Ngram Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))

scores = cross_val_score(naive_bayes.MultinomialNB(), total_chars, labels, cv=10)
print("NB Char Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
scores = cross_val_score(linear_model.LogisticRegression(), total_chars, labels, cv=10)
print("LR Char Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
scores = cross_val_score(ensemble.RandomForestClassifier(), total_chars, labels, cv=10)
print("RF Char Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
scores = cross_val_score(svm.SVC(), total_chars, labels, cv=10)
